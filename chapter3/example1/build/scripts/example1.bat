...
@rem ##########################################################################
@rem
@rem  example1 startup script for Windows
@rem
@rem ##########################################################################
...
@rem Execute example1
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %EXAMPLE_OPTS%  -classpath "%CLASSPATH%" hello.HelloWorld %CMD_LINE_ARGS%
